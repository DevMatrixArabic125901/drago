...
@dragoiq.ar_cmd(
    pattern="تشغيل_المكالمة$",
    command=("تشغيل_المكالمة", plugin_category),
    info={
...
@dragoiq.ar_cmd(
    pattern="انهاء_المكالمة$",
    command=("انهاء_المكالمة", plugin_category),
    info={
...
@dragoiq.ar_cmd(
    ...
    info={
        ...
        "الاستخـدام": "{tr}دعوة + معـرف/ايـدي الشخـص او بالـرد ع الشخـص",
        "مثــال :": [
            "{tr}دعوه @angelpro",
