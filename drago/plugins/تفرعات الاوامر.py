...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح اوامر التوجيه والأذاعة :\n– – – – – – – – – – – – – – – –\n↯︙ اختر احدى هذه الاوامر\n\n- ( `.وجه + نص` )\nلعمل اذاعة للنص في المجموعات اكتب الامر ونصك\n\n- ( `.حول + نص` )\nلعمل اذاعة للنص لل الدردشات الخاصة اكتب الامر ونصك\n\n– – – – – – – – – – – – – – – –\n↯︙قناة السورس ↫ ⦗ @MaTriXThon ⦘"
)
...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح امر الصورة الذاتية :\n– – – – – – – – – – – – – – – –\n↯︙ اختر احدى هذه الاوامر\n\n- ( `.ذاتية` )\n بالرد على الصورة ذاتية التدمير ليقوم بحفظها وارسالها لك في الرسائل المحفوظة بسرية وبدون علم الطرف الأخر \n- ( `.حفظ` )\n بالرد على الصورة الموجوده في المجموعة ذات التقييد المحتوى ليقوم بحفظها وارسالها لك في الرسائل المحفوظة بسرية وبدون علم الطرف الأخر\n( `.الذاتية تشغيل` )\n قم بكتابة الامر في أي مكان ليقوم بتفعيل الامر وحفظ الصور الذاتية التدمير تلقائياً\n( `.الذاتية تعطيل` )\n قم بكتابة الامر في مكان لتقوم بتعطيل الامر الصورة الذاتية التدمير\n\n– – – – – – – – – – – – – – – –\n↯︙قناة السورس ↫ ⦗ @MaTriXThon ⦘"
)
...
@dragoiq.ar_cmd(
    ...
    command=("اوامر الذكاء الاصطناعي", plugin_category),
           )
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح عن اوامر الذكاء الاصطناعي \n– – – – – – – – – – – – – – – –\n ↯︙ اختر احدى هذه الاوامر \n\n- ( `.تفعيل_الذكاء` ) \n  ليتم تشغيل الذكاء الاصطناعي على الاشخاص يجب كتابة \n\n- ( `.ذكاء + السؤال` ) \n امر الذكاء الاصطناعي اكتب\n\n– – – – – – – – – – – – – – – –\n↯︙ قناة السورس ↫ ⦗ @MaTriXThon ⦘"
	)
