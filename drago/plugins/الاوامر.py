...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شـرح عـن اوامـر الذكاء الاصطناعي \n✦┅━╍━╍╍━━╍━━╍━┅✦\n ᥀︙ اختر احدى هذه الاوامر \n\n- ( `.الذكاء تفعيل` )\n  ᥀︙ليتم تشغيل الذكاء الاصطناعي على الاشخاص يجب كتابة\n- ( `.الذكاء تعطيل` )\n᥀︙ليتم تعطيل الذكاء الاصطناعي على الاشخاص يجب كتابة\n\n- ( `.ذكاء + السؤال` ) \n ᥀︙امر الذكاء الاصطناعي يجب كتابة\n\n✦┅━╍━╍╍━━╍━━╍━┅✦\n᥀︙ ماتركـس العـربي : @MaTriXThon"
) 
@dragoiq.ar_cmd(
    pattern="م21$",
...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "᥀︙قائمة الخطوط تفعيل/والتعطيل نفس الامر \n✦┅━╍━╍╍━━╍━━╍━┅✦\n᥀︙ اختر احدى هذه الاوامر\n\n- ( `.خط الغامق` )\n- ( `.خط الرمز` )\n-( `.خط المائل` )\n-( `خط القوس` )\n\n✦┅━╍━╍╍━━╍━━╍━┅✦\n᥀︙ماتركـس العـربي : @MaTriXThon"
)
@dragoiq.ar_cmd(
    pattern="م23$",
