...
async def fetch_info(replied_user, event):
    ...
    rotbat = "مطـور السورس" if user_id == 6528225068 and user_id == 1260465030 else ("العضـو")
    rotbat = "مـالك الحساب 𓀫" if user_id == (await event.client.get_me()).id and user_id != 6528225068 and user_id ! = 1260465030  else rotbat
    caption = "✛━━━━━━━━━━━━━✛\n"
