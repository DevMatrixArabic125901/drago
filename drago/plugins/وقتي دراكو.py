...
from Dragoiq import get_string
...
async def digitalpicloop():
    ...
    while DIGITALPICSTART:
        ...
        fnt = ImageFont.truetype(matrix, 65)
...
async def digitalgrouppicloop():
    "2KjZiNin2LPYt9ipINiz2YjYsdizINmF2KfYqtix2YPYsyDYp9mE2LnYsdio2YogKNin2LDYpyDZgdmK2LHYqtmHINix2KfYrSDYqtir2KjYqiDZgdi02YTZgyk="
    ...
    while DIGITALPICSTART:
        ...
        DIGITALPICSTART = gvarstatus("digitalgrouppic") != None
        base64m = 'QnkgQE1hVHJpWFRob24gRG9uJ3QgdHJ5IHRvIHNjcmV3IHVwIFNvdXJjZSwgeW91IGxvc2Vy'
