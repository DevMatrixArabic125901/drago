...
async def ga(message):
    ...
    if ms == ".هههبهبنبخيحيييي" or ms == ".لننبمبمبخهب" or ms == ".نبنبمقمثمث":
...
async def thief(message):
    ...
    await dragoiq.send_file(
                message.chat_id,
                "https://telegra.ph/file/d4235635ba0f7d9f96164.jpg",
